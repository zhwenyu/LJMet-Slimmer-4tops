    ...
    for num in numlist :
 	...
 	runyear = ''
	  ...
	  era = (rootfiles[i].split('_')[0])[-1]
        ...
        dict={'RUNDIR':runDir, 'POST':runDirPost, 'RUNYEAR': runyear, 'ERA': era, 'DATETIME':run, 'INPATHSUFFIX':pathsuffix, 'CONDORDIR':condorDir, 'INPUTDIR':inDir, 'FILENAME':sample, 'CMSSWBASE':relbase, 'OUTPUTDIR':outDir, 'LIST':idlist, 'ID':tmpcount}
