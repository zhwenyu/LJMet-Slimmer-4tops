...
#relbase = '/uscms_data/d3/jmanagan/CMSSW_10_2_5/'
#inputDir='/eos/uscms/store/user/lpcljm/2018/LJMet102X_1lep_111618/'+shift+'/'
#outputDir='/eos/uscms/store/user/lpcljm/2018/LJMet102X_1lepTT_112818newB_step1/'+shift+'/'
#condorDir='/uscms_data/d3/jmanagan/LJMet102X_1lepTT_112818_step1/'+shift+'/'

relbase = '/uscms_data/d1/yiting11/CMSSW_9_4_6_patch1/'
inputDir='/eos/uscms/store/user/lpcljm/2018/LJMet102X_1lep_111618/'+shift+'/'
outputDir='/eos/uscms/store/user/lpcljm/yiting/step1_2018_try2/'+shift+'/'
condorDir='/uscms_data/d1/yiting11/step1_2018_try2/'+shift+'/'
...
if shift == 'nominal':
    dirList.append('Data18_EGamma_17Sep18')
    dirList.append('Data18_SingleMuon_17Sep18')
    dirList.append('Data18_EGamma2_17Sep18')
    dirList.append('Data18_SingleMuon2_17Sep18')
    dirList.append('Data18_EGamma3_17Sep18')
...
for sample in dirList:
    ...
    for i in range(0,len(rootfiles)):
        if int((rootfiles[i].split('_')[-1]).split('.')[0]) > maxfilenum:
            maxfilenum = int((rootfiles[i].split('_')[-1]).split('.')[0])

    print 'found',maxfilenum,'as largest index'
    tmpcount = 0
    for i in range(0,maxfilenum,40):
        rawname = relPath
        count += 1
        tmpcount += 1
        ...
        minid = i+1
        maxid = i+40
        if maxid > maxfilenum: maxid = maxfilenum
        print minid, maxid
